...
float	frexpf(float, int *) __NDK_FPABI_MATH__;	
...
float	modff(float, float *) __NDK_FPABI_MATH__;	
...
long double	frexpl(long double value, int *) __NDK_FPABI_MATH__; 
...
long double	modfl(long double, long double *) __NDK_FPABI_MATH__; 
...
double	__builtin_frexp(double, int *) __NDK_FPABI_MATH__;	
...
double	__builtin_modf(double, double *) __NDK_FPABI_MATH__;	
...
float	__builtin_frexpf(float, int *) __NDK_FPABI_MATH__;	
...
float	__builtin_modff(float, float *) __NDK_FPABI_MATH__;	
...
long double	__builtin_frexpl(long double value, int *) __NDK_FPABI_MATH__; 
...
long double	__builtin_modfl(long double, long double *) __NDK_FPABI_MATH__; 
