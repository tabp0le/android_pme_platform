...
void vp8_loop_filter_vertical_edge_y_neon(
    ...
    q4ResultL.val[0] = vget_low_u8(q5);   
    q4ResultL.val[1] = vget_low_u8(q6);   
    q4ResultL.val[2] = vget_low_u8(q7);   
    q4ResultL.val[3] = vget_low_u8(q8);   
    q4ResultH.val[0] = vget_high_u8(q5);  
    q4ResultH.val[1] = vget_high_u8(q6);  
    q4ResultH.val[2] = vget_high_u8(q7);  
    q4ResultH.val[3] = vget_high_u8(q8);  
