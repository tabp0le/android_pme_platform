...
void vp8_short_walsh4x4_neon(
    ...
    v2tmp3 = vtrn_s32(vreinterpret_s32_s16(d0s16),
                      vreinterpret_s32_s16(d2s16));
    v2tmp0 = vtrn_s16(vreinterpret_s16_s32(v2tmp3.val[1]),   
                      vreinterpret_s16_s32(v2tmp2.val[1]));  
    v2tmp1 = vtrn_s16(vreinterpret_s16_s32(v2tmp3.val[0]),   
                      vreinterpret_s16_s32(v2tmp2.val[0]));  
