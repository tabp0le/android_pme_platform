...
static volatile int signal_done = 0;	

static char *ibase = "replay";		
static char *idir = ".";		
static int cpus_to_use = -1;		
static int def_iterations = 1;		
static int naios = 512;			
static int ncpus = 0;			
static int verbose = 0;			
static int write_enabled = 0;		
static __u64 genesis = ~0;		
static __u64 rgenesis;			
static size_t pgsize;			
static int nb_sec = 512;		
static LIST_HEAD(input_devs);		
static LIST_HEAD(input_files);		
static LIST_HEAD(map_devs);		
static int nfiles = 0;			
static int no_stalls = 0;		
static unsigned acc_factor = 1;		
static int find_records = 0;		
