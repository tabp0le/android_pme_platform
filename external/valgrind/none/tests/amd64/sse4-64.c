...
static void do64HLtoV128 ( V128* res, ULong wHi, ULong wLo )
{
...
void do_ROUNDSD_000 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDSD_001 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDSD_010 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDSD_011 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDSD_1XX ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDSS_000 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDSS_001 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDSS_010 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDSS_011 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDSS_1XX ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDPD_000 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDPD_001 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDPD_010 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDPD_011 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDPD_1XX ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDPS_000 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDPS_001 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDPS_010 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDPS_011 ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_ROUNDPS_1XX ( Bool mem, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd  (%1), %%xmm11"       "\n\t"
...
void do_PBLENDVB ( Bool mem, V128* xmm0, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd   (%2), %%xmm0"         "\n\t"
...
void test_PBLENDVB ( void )
{
   ...
   for (i = 0; i < 10; i++) {
      ...
      memcpy(&src, &t_src, 16);
      memcpy(&dst, &t_dst, 16);
      do_PBLENDVB(False, &xmm0, &src, &dst);
      printf("r pblendvb  ");
      showV128(&t_xmm0);
      printf(" ");
      showV128(&t_src);
...
void do_BLENDVPD ( Bool mem, V128* xmm0, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd   (%2), %%xmm0"         "\n\t"
...
void test_BLENDVPD ( void )
{
   ...
   for (i = 0; i < 10; i++) {
      ...
      memcpy(&src, &t_src, 16);
      memcpy(&dst, &t_dst, 16);
      do_BLENDVPD(False, &xmm0, &src, &dst);
      printf("r blendvpd  ");
      showV128(&t_xmm0);
      printf(" ");
      showV128(&t_src);
...
void do_BLENDVPS ( Bool mem, V128* xmm0, V128* src, V128* dst )
{
   if (mem) {
      __asm__ __volatile__(
         "movupd   (%2), %%xmm0"         "\n\t"
...
void test_BLENDVPS ( void )
{
   ...
   for (i = 0; i < 10; i++) {
      ...
      memcpy(&src, &t_src, 16);
      memcpy(&dst, &t_dst, 16);
      do_BLENDVPS(False, &xmm0, &src, &dst);
      printf("r blendvps  ");
      showV128(&t_xmm0);
      printf(" ");
      showV128(&t_src);
