...
static int old_main(void)
{
	...
	printf("------------ PLD/PLDW (begin) ------------\n");
        { int alocal;
          ...
          __asm__ __volatile__( "pld [%0, #128]" : :"r"(&alocal) );
          __asm__ __volatile__( "pld [%0, #-128]" : :"r"(&alocal) );
          __asm__ __volatile__( "pld [r15, #-128]" : :"r"(&alocal) );
          ...
          __asm__ __volatile__( "pld [%0, %1]" : : "r"(&alocal), "r"(0) );
          __asm__ __volatile__( "pld [%0, %1, LSL #1]" : : "r"(&alocal), "r"(0) );
#if 0
          __asm__ __volatile__( "pld [%0, %1, LSR #1]" : : "r"(&alocal), "r"(0) );
          __asm__ __volatile__( "pld [%0, %1, ASR #1]" : : "r"(&alocal), "r"(0) );
          __asm__ __volatile__( "pld [%0, %1, ROR #1]" : : "r"(&alocal), "r"(0) );
          __asm__ __volatile__( "pld [%0, %1, RRX]" : : "r"(&alocal), "r"(0) );
#endif
        }
...
int main ( void )
{
   ...
   printf("CMP-16 0x10a\n");
   TESTCARRY
   TESTINST3("cmp r3, r6", 0,          0,           r6, r3, r6, 0);
   TESTINST3("cmp r3, r6", 1,          0,           r6, r3, r6, 0);
   TESTINST3("cmp r3, r6", 0,          1,           r6, r3, r6, 0);
   TESTINST3("cmp r3, r6", -1,         0,           r6, r3, r6, 0);
   TESTINST3("cmp r3, r6", 0,          -1,          r6, r3, r6, 0);
   TESTINST3("cmp r3, r6", 0,          0x80000000,  r6, r3, r6, 0);
   TESTINST3("cmp r3, r6", 0x80000000, 0,           r6, r3, r6, 0);
   TESTCARRYEND

   printf("CMN-16 0x10a\n");
   TESTCARRY
   TESTINST3("cmn r3, r6", 0,          0,           r6, r3, r6, 0);
   TESTINST3("cmn r3, r6", 1,          0,           r6, r3, r6, 0);
   TESTINST3("cmn r3, r6", 0,          1,           r6, r3, r6, 0);
   TESTINST3("cmn r3, r6", -1,         0,           r6, r3, r6, 0);
   TESTINST3("cmn r3, r6", 0,          -1,          r6, r3, r6, 0);
   TESTINST3("cmn r3, r6", 0,          0x80000000,  r6, r3, r6, 0);
   TESTINST3("cmn r3, r6", 0x80000000, 0,           r6, r3, r6, 0);
   TESTCARRYEND

   printf("TST-16 0x108\n");
   TESTCARRY
   TESTINST3("tst r3, r6", 0,          0,           r6, r3, r6, cv);
   TESTINST3("tst r3, r6", 1,          0,           r6, r3, r6, cv);
   TESTINST3("tst r3, r6", 0,          1,           r6, r3, r6, cv);
   TESTINST3("tst r3, r6", 1,          1,           r6, r3, r6, cv);
   TESTINST3("tst r3, r6", -1,         0,           r6, r3, r6, cv);
   TESTINST3("tst r3, r6", 0,          -1,          r6, r3, r6, cv);
   TESTINST3("tst r3, r6", -1,         -1,          r6, r3, r6, cv);
   TESTCARRYEND
   ...
   TESTCARRY
   TESTINST3("cmp r5, r12", 0,          0,           r12, r5, r12, 0);
   TESTINST3("cmp r5, r12", 1,          0,           r12, r5, r12, 0);
   TESTINST3("cmp r5, r12", 0,          1,           r12, r5, r12, 0);
   TESTINST3("cmp r5, r12", -1,         0,           r12, r5, r12, 0);
   TESTINST3("cmp r5, r12", 0,          -1,          r12, r5, r12, 0);
   TESTINST3("cmp r5, r12", 0,          0x80000000,  r12, r5, r12, 0);
   TESTINST3("cmp r5, r12", 0x80000000, 0,           r12, r5, r12, 0);
   TESTCARRYEND
