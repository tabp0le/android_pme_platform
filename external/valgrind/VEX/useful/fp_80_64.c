...
static void convert_f80le_to_f64le_HW ( UChar* f80, UChar* f64 )
{
...
static void convert_f64le_to_f80le_HW ( UChar* f64, UChar* f80 )
{
...
static void convert_f64le_to_f80le ( UChar* f64, UChar* f80 )
{
   Bool  mantissaIsZero;
   Int   bexp, i, j, shift;
   UChar sign;
...
static void convert_f80le_to_f64le ( UChar* f80, UChar* f64 )
{
   Bool  isInf;
   Int   bexp, i, j;
   UChar sign;
