...
Int VG_(check_executable)(Bool* is_setuid,
...
Int VG_(mkstemp) ( const HChar* part_of_name, HChar* fullname )
{
   Int    n, tries;
   UInt   seed;
   SysRes sres;
...
#  if defined(VGO_linux) || defined(VGO_darwin)
   ...
   sd = VG_(socket)(VKI_AF_INET, VKI_SOCK_STREAM, 0 );
   if (sd < 0) {
