...
Long VG_(strtoll10) ( const HChar* str, HChar** endptr )
{
   ...
   if (!converted) str = str0;   
   if (neg) n = -n;              
   if (endptr)
      *endptr = CONST_CAST(HChar *,str); 
   return n;
}
                           ...
                           UInt *enum_set)
{
   ...
   if (tokens_len > 1000) return False; 
   ...
   if (input_len > 1000) return False; 
