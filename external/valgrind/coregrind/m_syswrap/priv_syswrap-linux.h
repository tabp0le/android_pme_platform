...
DECL_TEMPLATE(linux, sys_setresuid);    
DECL_TEMPLATE(linux, sys_getresuid16);
DECL_TEMPLATE(linux, sys_getresuid);
DECL_TEMPLATE(linux, sys_setresgid16);  
DECL_TEMPLATE(linux, sys_setresgid);    
...
DECL_TEMPLATE(linux, sys_timer_create);      
