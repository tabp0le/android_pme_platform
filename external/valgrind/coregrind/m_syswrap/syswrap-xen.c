...
static XenHypercallTableEntry hypercall_table[] = {
   ...
   HYPXY(__VKI_XEN_memory_op,               memory_op,         2), 
   
   

   
   HYPXY(__VKI_XEN_event_channel_op_compat, evtchn_op_compat,  1), 
   HYPXY(__VKI_XEN_xen_version,             xen_version,       2), 
   
   

   HYPXY(__VKI_XEN_grant_table_op,          grant_table_op,    3), 
   ...
   HYPXY(__VKI_XEN_mmuext_op,               mmuext_op,         2), 
   ...
   HYPXY(__VKI_XEN_event_channel_op,        evtchn_op,         2), 
   
   HYPXY(__VKI_XEN_hvm_op,                  hvm_op,            2), 

   HYPXY(__VKI_XEN_sysctl,                  sysctl,            1), 
   HYPXY(__VKI_XEN_domctl,                  domctl,            1), 
   
   HYPXY(__VKI_XEN_tmem_op,                 tmem_op,           1), 
};
