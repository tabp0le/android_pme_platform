...
DECL_TEMPLATE(generic, sys_ni_syscall);            
...
DECL_TEMPLATE(generic, sys_execve);    
...
DECL_TEMPLATE(generic, sys_mremap);    
...
DECL_TEMPLATE(generic, sys_setgroups);             
...
DECL_TEMPLATE(generic, sys_nice);      
DECL_TEMPLATE(generic, sys_sync);      
DECL_TEMPLATE(generic, sys_brk);       
DECL_TEMPLATE(generic, sys_acct);      
DECL_TEMPLATE(generic, sys_chroot);    
DECL_TEMPLATE(generic, sys_readlink);  
DECL_TEMPLATE(generic, sys_fchdir);    
DECL_TEMPLATE(generic, sys_getdents);  
DECL_TEMPLATE(generic, sys_select);    
DECL_TEMPLATE(generic, sys_flock);     
DECL_TEMPLATE(generic, sys_poll);      
DECL_TEMPLATE(generic, sys_getrusage); 
DECL_TEMPLATE(generic, sys_stime);	    
DECL_TEMPLATE(generic, sys_settimeofday); 
DECL_TEMPLATE(generic, sys_getpriority);  
DECL_TEMPLATE(generic, sys_setpriority);  
DECL_TEMPLATE(generic, sys_setitimer);    
DECL_TEMPLATE(generic, sys_getitimer);    
DECL_TEMPLATE(generic, sys_setreuid);     
DECL_TEMPLATE(generic, sys_setregid);     
DECL_TEMPLATE(generic, sys_fchown);       
DECL_TEMPLATE(generic, sys_setgid);       
DECL_TEMPLATE(generic, sys_utimes);       

DECL_TEMPLATE(generic, sys_sigaction);             

DECL_TEMPLATE(generic, sys_newstat);               
DECL_TEMPLATE(generic, sys_newlstat);              
DECL_TEMPLATE(generic, sys_newfstat);              

DECL_TEMPLATE(generic, sys_ptrace);                
DECL_TEMPLATE(generic, sys_setrlimit);             
DECL_TEMPLATE(generic, sys_old_getrlimit);         
DECL_TEMPLATE(generic, sys_statfs);                
DECL_TEMPLATE(generic, sys_fstatfs);               
DECL_TEMPLATE(generic, sys_iopl);                  
DECL_TEMPLATE(generic, sys_newuname);              
DECL_TEMPLATE(generic, sys_pread64);               
DECL_TEMPLATE(generic, sys_pwrite64);              
DECL_TEMPLATE(generic, sys_sigaltstack);           
DECL_TEMPLATE(generic, sys_getpmsg);               
DECL_TEMPLATE(generic, sys_putpmsg);               
DECL_TEMPLATE(generic, sys_getrlimit);             
DECL_TEMPLATE(generic, sys_truncate64);            
DECL_TEMPLATE(generic, sys_ftruncate64);           
DECL_TEMPLATE(generic, sys_lchown);                
DECL_TEMPLATE(generic, sys_mincore);               
DECL_TEMPLATE(generic, sys_getdents64);            
