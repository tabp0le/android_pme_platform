...
Intel_cache_info(Int level, VexCacheInfo *ci)
{
   ...
   for (i = 0; i < 16; i++) {
      ...
      case 0x60: add_D1(16, 8, 64);  break;      
      case 0x66: add_D1( 8, 4, 64);  break;      
      case 0x67: add_D1(16, 4, 64);  break;      
      case 0x68: add_D1(32, 4, 64);  break;      
...
get_cache_info(VexArchInfo *vai)
{
   ...
   for (level = 0; level < 8; level++) {
      ...
      cache_kind = info & 0x3;
      switch (cache_kind) {
      case 0:  ci->num_caches += 2; break; 
      case 1:  ci->num_caches += 1; break; 
      case 2:  ci->num_caches += 1; break; 
      case 3:  ci->num_caches += 1; break; 
      }
   }
