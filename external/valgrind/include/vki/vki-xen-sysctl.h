...
struct vki_xen_sysctl_readconsole {
    ...
    vki_uint32_t index;
    VKI_XEN_GUEST_HANDLE_64(char) buffer; 
...
#define VKI_XEN_SYSCTL_CPUPOOL_OP_CREATE                1  
#define VKI_XEN_SYSCTL_CPUPOOL_OP_DESTROY               2  
#define VKI_XEN_SYSCTL_CPUPOOL_OP_INFO                  3  
#define VKI_XEN_SYSCTL_CPUPOOL_OP_ADDCPU                4  
#define VKI_XEN_SYSCTL_CPUPOOL_OP_RMCPU                 5  
#define VKI_XEN_SYSCTL_CPUPOOL_OP_MOVEDOMAIN            6  
#define VKI_XEN_SYSCTL_CPUPOOL_OP_FREEINFO              7  
#define VKI_XEN_SYSCTL_CPUPOOL_PAR_ANY     0xFFFFFFFF
struct vki_xen_sysctl_cpupool_op {
    vki_uint32_t op;          
    vki_uint32_t cpupool_id;  
...
struct vki_xen_sysctl_physinfo_00000008 {
    ...
    vki_uint32_t max_cpu_id;  
    vki_uint32_t nr_nodes;    
    vki_uint32_t max_node_id; 
