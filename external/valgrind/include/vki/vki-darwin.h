...
#define VM_TAG_VALGRIND VM_MAKE_TAG(239)  
...
#define VKI_CS_OPS_STATUS           0       
#define VKI_CS_OPS_MARKINVALID      1       
#define VKI_CS_OPS_MARKHARD         2       
#define VKI_CS_OPS_MARKKILL         3       
#define VKI_CS_OPS_PIDPATH          4       
#define VKI_CS_OPS_CDHASH           5       
...
#define VKI_WQOPS_QUEUE_NEWSPISUPP  16  
#define VKI_WQOPS_QUEUE_REQTHREADS  32  
