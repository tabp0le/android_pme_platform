...
#define VG_DARWIN_SYSCALL_CLASS_NONE      0       
#define VG_DARWIN_SYSCALL_CLASS_MACH      1             
#define VG_DARWIN_SYSCALL_CLASS_UNIX      2       
#define VG_DARWIN_SYSCALL_CLASS_MDEP      3       
#define VG_DARWIN_SYSCALL_CLASS_DIAG      4       
...
#define __NR_sched_yield  __NR_swtch  
...
#define	__NR_fork           VG_DARWIN_SYSCALL_CONSTRUCT_UNIX(2) 
...
#define	__NR_pipe           VG_DARWIN_SYSCALL_CONSTRUCT_UNIX(42) 
...
#define	__NR_lseek          VG_DARWIN_SYSCALL_CONSTRUCT_UNIX(199) 
...
#if DARWIN_VERS >= DARWIN_10_6
#define __NR___thread_selfid VG_DARWIN_SYSCALL_CONSTRUCT_UNIX(372)  
#else
