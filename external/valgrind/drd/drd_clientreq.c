...
static Bool handle_client_request(ThreadId vg_tid, UWord* arg, UWord* ret)
{
   ...
   case VG_USERREQ__MALLOCLIKE_BLOCK:
      ...
      if (arg[1])
         DRD_(malloclike_block)(vg_tid, arg[1], arg[2]);
      break;

   case VG_USERREQ__RESIZEINPLACE_BLOCK:
      if (!DRD_(freelike_block)(vg_tid, arg[1], False))
      {
         GenericErrInfo GEI = {
            .tid = DRD_(thread_get_running_tid)(),
            .addr = 0,
      ...
      DRD_(malloclike_block)(vg_tid, arg[1], arg[3]);
      break;

   case VG_USERREQ__FREELIKE_BLOCK:
      if (arg[1] && ! DRD_(freelike_block)(vg_tid, arg[1], False))
      {
         GenericErrInfo GEI = {
	    .tid = DRD_(thread_get_running_tid)(),
	    .addr = 0,
   ...
   case VG_USERREQ__DRD_ANNOTATE_SEM_WAIT_POST:
      DRD_(semaphore_post_wait)(drd_tid, arg[1], True );
      break;
   ...
   case VG_USERREQ__POST_MUTEX_LOCK:
      if (DRD_(thread_leave_synchr)(drd_tid) == 0)
         DRD_(mutex_post_lock)(arg[1], arg[2], False);
      break;
