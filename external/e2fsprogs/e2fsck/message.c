...
{
	N_("<The NULL inode>"),			
	N_("<The bad blocks inode>"),		
	"/",					
	N_("<The user quota inode>"),		
	N_("<The group quota inode>"),		
	N_("<The boot loader inode>"),		
	N_("<The undelete directory inode>"),	
	N_("<The group descriptor inode>"),	
	N_("<The journal inode>"),		
	N_("<Reserved inode 9>"),		
	N_("<Reserved inode 10>"),		
};
