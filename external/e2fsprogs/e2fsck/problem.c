...
static const char *prompt[] = {
	...
	N_("Split"),		
	N_("Continue"),		
	N_("Clone multiply-claimed blocks"), 
	N_("Delete file"),	
	N_("Suppress messages"),
	N_("Unlink"),		
	N_("Clear HTree index"),
	N_("Recreate"),		
	"",			
};
...
static const char *preen_msg[] = {
	...
	N_("SPLIT"),		
	N_("CONTINUING"),	
	N_("MULTIPLY-CLAIMED BLOCKS CLONED"), 
	N_("FILE DELETED"),	
	N_("SUPPRESSED"),	
	N_("UNLINKED"),		
	N_("HTREE INDEX CLEARED"),
	N_("WILL RECREATE"),	
	"",			
};
