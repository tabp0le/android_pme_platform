...
static const Ebl_Register_Location fpregset_regs[] =
  {
    { .offset = 0, .regno = 37, .count = 2, .bits = 32 }, 
    { .offset = 7 * 4, .regno = 11, .count = 8, .bits = 80 }, 
  };
#define FPREGSET_SIZE	108

static const Ebl_Register_Location prxfpreg_regs[] =
  {
    { .offset = 0, .regno = 37, .count = 2, .bits = 16 }, 
    { .offset = 24, .regno = 39, .count = 1, .bits = 32 }, 
    { .offset = 32, .regno = 11, .count = 8, .bits = 80, .pad = 6 }, 
    { .offset = 32 + 128, .regno = 21, .count = 8, .bits = 128 }, 
  };
