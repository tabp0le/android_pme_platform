...
static const struct
{
...
} special_sections[] =
  {
    ...
    { ".interp", 8, SHT_PROGBITS, atleast, 0, SHF_ALLOC }, 
    { ".line", 6, SHT_PROGBITS, exact, 0, 0 },
    { ".note", 6, SHT_NOTE, atleast, 0, SHF_ALLOC },
    { ".plt", 5, SHT_PROGBITS, unused, 0, 0 }, 
    { ".preinit_array", 15, SHT_PREINIT_ARRAY, exact, SHF_ALLOC | SHF_WRITE, 0 },
    { ".rela", 5, SHT_RELA, atleast, 0, SHF_ALLOC | SHF_INFO_LINK }, 
    { ".rel", 4, SHT_REL, atleast, 0, SHF_ALLOC | SHF_INFO_LINK }, 
    ...
    { ".strtab", 8, SHT_STRTAB, atleast, 0, SHF_ALLOC }, 
    { ".symtab", 8, SHT_SYMTAB, atleast, 0, SHF_ALLOC }, 
    { ".symtab_shndx", 14, SHT_SYMTAB_SHNDX, atleast, 0, SHF_ALLOC }, 
