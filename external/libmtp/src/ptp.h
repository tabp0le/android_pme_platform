...
#define PTP_OC_NIKON_AfDrive		0x90C1	
#define PTP_OC_NIKON_SetControlMode	0x90C2	
#define PTP_OC_NIKON_DelImageSDRAM	0x90C3	
...
#define PTP_OC_NIKON_SetPreWBData	0x90C9	
#define PTP_OC_NIKON_GetVendorPropCodes	0x90CA	
...
struct _PTPPropDescEnumForm {
	...
	PTPPropertyValue	*SupportedValue;	
};
...
struct _PTPCanon_changes_entry {
	int	type;
	union {
		struct _PTPCanon_New_Object	object;	
	} u;
};
...
#define PTP_DPC_CANON_EOS_ImageFormatCF		0xD121	
#define PTP_DPC_CANON_EOS_ImageFormatSD		0xD122	
#define PTP_DPC_CANON_EOS_ImageFormatExtHD	0xD123	
...
#define PTP_DPC_NIKON_RecordingMedia			0xD10B	
